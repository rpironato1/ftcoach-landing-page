  ...
  return (
    <div className="min-h-screen py-20 bg-muted/20">
      ...
      <div className="prose prose-lg max-w-none dark:prose-invert">
        ...
        <ul>
          {(t('accessibility.measures.items', { returnObjects: true }) as string[]).map((item, index) => (
        ...
        <div className="grid md:grid-cols-3 gap-6 my-8">
          <Card>
            <CardHeader className="items-center text-center">
              ...
              <CardTitle>{t('accessibility.cards.visual.title')}</CardTitle>
            </CardHeader>
            <CardContent className="text-sm text-center">
              {t('accessibility.cards.visual.description')}
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="items-center text-center">
              <Ear className="h-8 w-8 text-primary mb-2" />
              <CardTitle>{t('accessibility.cards.auditory.title')}</CardTitle>
            </CardHeader>
            <CardContent className="text-sm text-center">
              {t('accessibility.cards.auditory.description')}
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="items-center text-center">
              <MousePointerClick className="h-8 w-8 text-primary mb-2" />
              <CardTitle>{t('accessibility.cards.motor.title')}</CardTitle>
            </CardHeader>
            <CardContent className="text-sm text-center">
              {t('accessibility.cards.motor.description')}
            </CardContent>
          </Card>
        </div>
        ...
        <p>
          <Trans i18nKey="accessibility.feedback.email">
