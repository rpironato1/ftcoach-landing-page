...
const Team = () => {
  ...
  const teamMembers = [
    {
      ...
      achievements: t('team.members.ricardo.achievements', { returnObjects: true }) as string[],
      social: {
    ...
    },
    {
      ...
      achievements: t('team.members.ana.achievements', { returnObjects: true }) as string[],
      social: {
        linkedin: "https://linkedin.com",
        twitter: "https://twitter.com",
    ...
    },
    {
      ...
      achievements: t('team.members.carlos.achievements', { returnObjects: true }) as string[],
      social: {
        linkedin: "https://linkedin.com",
        twitter: "https://twitter.com",
    ...
    },
    {
      ...
      achievements: t('team.members.mariana.achievements', { returnObjects: true }) as string[],
      social: {
        linkedin: "https://linkedin.com",
        twitter: "https://twitter.com",
    ...
    },
    {
      ...
      achievements: t('team.members.pedro.achievements', { returnObjects: true }) as string[],
      social: {
        linkedin: "https://linkedin.com",
        twitter: "https://twitter.com",
    ...
    },
    {
      ...
      achievements: t('team.members.juliana.achievements', { returnObjects: true }) as string[],
      social: {
        linkedin: "https://linkedin.com",
        twitter: "https://twitter.com",
  ...
  const advisors = [
    {
      name: t('team.advisorList.roberto.name'),
      role: t('team.advisorList.roberto.role'),
      company: t('team.advisorList.roberto.company'),
      expertise: t('team.advisorList.roberto.expertise')
    },
    {
      name: t('team.advisorList.patricia.name'),
      role: t('team.advisorList.patricia.role'),
      company: t('team.advisorList.patricia.company'),
      expertise: t('team.advisorList.patricia.expertise')
    },
    {
      name: t('team.advisorList.fernando.name'),
      role: t('team.advisorList.fernando.role'),
      company: t('team.advisorList.fernando.company'),
      expertise: t('team.advisorList.fernando.expertise')
    }
  ];
