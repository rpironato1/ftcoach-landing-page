...
import { Check, X, Zap, Users, Crown, Star, Target, Award, Rocket } from 'lucide-react';
        ...
        <div className="mt-20 text-center">
          <Card className="border-0 bg-gradient-to-r from-primary/5 to-primary/10">
            <CardContent className="p-8">
              <h3 className="text-2xl font-bold mb-4">{t('personalPlans.cta.title')}</h3>
              <p className="text-muted-foreground mb-6">
                {t('personalPlans.cta.subtitle')}
              </p>
              <div className="flex gap-4 justify-center">
                <Button variant="default">{t('personalPlans.cta.primary')}</Button>
                <Button variant="outline">{t('personalPlans.cta.secondary')}</Button>
              </div>
            </CardContent>
          </Card>
        </div>
